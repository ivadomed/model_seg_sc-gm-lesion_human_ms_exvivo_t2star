...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Publication-facing 2D nnU-Net inference entrypoint."
    )
    ...
    parser.add_argument("--model-folder", required=True, help="Path to trained 2D model folder.")
    parser.add_argument(
        "--folds",
        nargs="+",
        default=["0", "1", "2", "3"],
    ...
    parser.add_argument("--num-preproc-workers", type=int, default=2)
    parser.add_argument("--num-export-workers", type=int, default=2)
